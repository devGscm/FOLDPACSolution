...
{
	static let INDICATOR_COLOR_GRAY							= 1
	static let INDICATOR_COLOR_WHITE						= 2
	...
	init(view : UIView, backgroundColor: UIColor, indicatorColor: Int, message : String)
	{
		...
		self.backgroundColor = UIColorFromHex(rgbValue : 0x000000, alpha: 0.3)
